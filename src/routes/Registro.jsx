...
const obtenerValoresPreguntasSecretas = async () => {
    try {
      const response = await axios.get('http://localhost:3000/preguntas-secretas');
                    ...
                    <Form
                            ...
                            rules={[
                                {
                                    validator: async (_, value) => {
                                        if (!value || typeof value !== 'string') {
                                            throw new Error('Por favor, ingresa la CURP');
                                        }
                        ...
                        >
                            <Input
                                ...
                                placeholder="Ingrese la CURP del personal a registrar"
                            />
                        </Form.Item>

                        <Contenido conTit={"Plantel de trabajo:"} />
                        <Form.Item name="plantel" rules={[{ required: true, message: 'Por favor, selecciona el plantel de trabajo del personal a registrar' }]}>
                            <Select placeholder="Seleccione el plantel de trabajo del personal a registrar" suffixIcon={<IdcardOutlined />}>
                        ...
                        <Form.Item
                            name="sesion"
                            rules={[{ required: true, message: <Notificacion noti={"Por favor, selecciona el tipo de sesión del personal a registrar"} /> }]}>
                            <Select
                                placeholder="Seleccione el tipo de sesión del personal a registrar"
                        ...
                        <Form.Item
                            ...
                            rules={[
                                {
                                    required: true,
                                    message: <Notificacion noti={"Por favor, ingresa el nombre(s) del personal a registra"} />,
                                },
                                {
                                    validator: (_, value) => {
                                        ...
                                        return Promise.reject('La primera letra debe ser mayúscula.');
                                    },
                                },
                                {
                        ...
                        >
                            <Input
                                prefix={<UserOutlined />}
                                placeholder="Ingrese el nombre del personal a registrar"
                            />
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            rules={[
                                {
                                    required: true,
                                    message: <Notificacion noti={"Por favor, ingresa tu apellido paterno"} />,
                                },
                                {
                                    validator: (_, value) => {
                                        const trimmedValue = value && value.trim();
                                        if (/^[A-Z]/.test(trimmedValue)) {
                                            if (value !== trimmedValue) {
                                                return Promise.reject('No se permiten espacios inicio/final.');
                                            }
                                            return Promise.resolve();
                                        }
                                        return Promise.reject('La primera letra debe ser mayúscula.');
                        ...
                        >
                            <Input
                                prefix={<UserOutlined />}
                                placeholder="Ingrese el apellido paterno del personal a registrar"
                            />
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            rules={[
                                {
                                    required: true,
                                    message: <Notificacion noti={"Por favor, ingresa tu apellido materno"} />,
                                },
                                {
                                    validator: (_, value) => {
                                        const trimmedValue = value && value.trim();
                                        if (/^[A-Z]/.test(trimmedValue)) {
                                            if (value !== trimmedValue) {
                                                return Promise.reject('No se permiten espacios al inicio/final.');
                                            }
                                            return Promise.resolve();
                                        }
                                        return Promise.reject('La primera letra debe ser mayúscula.');
                        ...
                        >
                            <Input
                                prefix={<UserOutlined />}
                                placeholder="Ingrese el apellido materno del personal a registrar"
                            />
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            rules={[
                                {
                                    required: true,
                                    message: <Notificacion noti={"Por favor, ingresa tu número de teléfono"} />,
                                },
                                {
                                    pattern: /^[0-9]{10}$/,
                                    message: <Notificacion noti={"El número de teléfono debe contener exactamente 10 números"} />,
                                },
                            ]}
                        >
                            <Input
                                prefix={<PhoneOutlined />}
                                placeholder="Ingrese el número de teléfono del personal a registrar"
                            />
                        </Form.Item>
...
<Form.Item
  name="pregunta"
  rules={[{ required: true, message: <Notificacion noti={"Por favor, selecciona la pregunta secreta para el personal"} /> }]}>
  <Select
    placeholder="Seleccione la pregunta secreta para el persona a registrar"
    suffixIcon={<IdcardOutlined />}>
...
<Form.Item
    ...
    rules={[
        {
            required: true,
            message: <Notificacion noti={"Por favor, ingresa la respuesta a la pregunta"} />,
        },
        {
...
>
    <Input
        prefix={<UserOutlined />}
        placeholder="Ingrese la respuesta a la pregunta del personal a registrar"
    />
</Form.Item>
                        ...
                        <Form.Item
                            ...
                            rules={[
                                {
                                    required: true,
                                    message: <Notificacion noti={"Por favor, ingresa tu contraseña"} />,
                                },
                                {
                                    validator: async (_, value) => {
                                        try {
                        ...
                        >
                            <Input.Password
                                prefix={<LockOutlined />}
                                placeholder="Ingrese la contraseña del personal a registrar"
                            />
                        </Form.Item>
                                ...
                                ({ getFieldValue }) => ({
                                    validator(_, value) {
                                        if (!value || getFieldValue('contra') === value) {
                                            ...
                                            setPasswordsMatchMessage('Las contraseñas coinciden.');  // Añade esta línea
                                            return Promise.resolve();
                                        }
                                        setPasswordMatch(false);
                                        setPasswordsMatchMessage('Las contraseñas no coinciden.');  // Añade esta línea
                        ...
                        >
                            <Input.Password
                                prefix={<LockOutlined />}
                                placeholder="Confirme la contraseña antes ingresada"
                            />
                        </Form.Item>

                        {/* Mostrar mensaje si las contraseñas no coinciden */}
                        {!passwordMatch && (
                            <Alert message="Las contraseñas no coinciden." type="error" />
                        )}

                        {/* Mostrar mensaje si las contraseñas coinciden */}
                        {passwordMatch && passwordsMatchMessage && (
                            <Alert message={passwordsMatchMessage} type="success" />
                        )}
                        <Form.Item>
